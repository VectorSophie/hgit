...
<package xmlns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd">
  <metadata>
    ...
    <iconUrl>https://raw.githubusercontent.com/VectorSophie/hgit/main/docs/brand/hgitlogo.png</iconUrl>
    ...
    <packageSourceUrl>https://github.com/VectorSophie/hgit/tree/main/packaging/chocolatey</packageSourceUrl>
    <releaseNotes>https://github.com/VectorSophie/hgit/releases/tag/v$VER</releaseNotes>
