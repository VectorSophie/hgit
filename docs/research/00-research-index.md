...
| [04-vcs-comparison.md](04-vcs-comparison.md) | 🟡 | jj's operation log, Fossil's delta format, Sapling's undo/absorb model, Mercurial's obsolescence markers, and GitButler's virtual branches all read and compared; Pijul/Darcs/Breezy still unfetched |
