...
| [05-git-internals-and-product-practice.md](05-git-internals-and-product-practice.md) | 🟡 | Object model, refs/reflog, fsck/recovery, and rename inference now real parts of hgit itself (not just research); merge-base/three-way merge researched and its object-model prerequisite verified (probe 97) - the real merge algorithm itself is separate, ongoing work; packfiles/commit-graph/protocol v2 still not fetched, lower priority at TempleOS's own stated scale |
