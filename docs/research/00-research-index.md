...
| [04-vcs-comparison.md](04-vcs-comparison.md) | 🟡 | jj's operation log, Fossil's delta format, Sapling's undo/absorb model, Mercurial's obsolescence markers, GitButler's virtual branches, and Pijul's patch theory (comparison only) all read and compared - the last of these directly informs ADR 0011's own "what would justify revisiting" list; Darcs/Breezy still unfetched |
