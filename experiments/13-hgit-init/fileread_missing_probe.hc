...
// First: does FileRead return NULL for a nonexistent file, or throw?
// Test directly rather than assume.
I64 probe_size;
U8 *probe = FileRead("C:/Home/DefinitelyDoesNotExist.hgs", &probe_size);
CommPrint(1,"probe_null=%d probe_size=%d\n", probe==NULL, probe_size);
