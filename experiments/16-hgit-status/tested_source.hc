...
// Test 1: a path that isn't a repo at all.
HgitStatus("C:/Home/DefinitelyNotARepo.hgs");
// Test 2: a real, freshly-created empty repo (reuse HgitInit).
HgitInit("C:/Home/StatusTestRepo.hgs");
HgitStatus("C:/Home/StatusTestRepo.hgs");
